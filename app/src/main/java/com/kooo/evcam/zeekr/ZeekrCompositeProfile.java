...
public final class ZeekrCompositeProfile {
     ...
     * 实测确认过的合成流尺寸。
     *
     * <p>只有一个：诊断报告里相机 2（EXTERNAL）声明的 1280×5140。
     * 原来还列着 1280×5120 和 5120×1280 —— 那两个<b>这台车从来没声明过</b>，
     * 是照着别的资料写上去的。留着会让「命中已知实测尺寸」这句话变成假的。</p>
     *
     * <p>别的固件给别的长条尺寸时，靠长宽比那条兜底路径照样认得出来。</p>
     */
    ...
    public static String describe(Size size) {
        ...
        CompositeStreamGeometry.Plan plan =
                CompositeStreamGeometry.analyse(StreamLayoutTable.compositeCameraId(), size.getWidth(), size.getHeight());
